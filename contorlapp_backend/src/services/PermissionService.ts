...
const PERMISSION_CATALOG: PermissionDefinition[] = [
  ...
  {
    key: "maquinaria.crear",
    module: "maquinaria",
    moduleLabel: "Maquinaria",
    label: "Registrar maquinaria",
    description: "Permite registrar unidades de maquinaria en inventario.",
  },
  {
    key: "maquinaria.editar",
    module: "maquinaria",
    moduleLabel: "Maquinaria",
    label: "Editar maquinaria",
    description: "Permite editar unidades aprobadas y sus datos administrativos.",
  },
  {
    key: "maquinaria.aprobar",
    module: "maquinaria",
    moduleLabel: "Maquinaria",
    label: "Aprobar maquinaria",
    description: "Permite aprobar o rechazar altas pendientes de maquinaria.",
  },
  {
    key: "maquinaria.gestionar_estado",
    module: "maquinaria",
    moduleLabel: "Maquinaria",
    label: "Gestionar estado de maquinaria",
    description: "Permite cambiar el estado físico o retirar maquinaria.",
  },
  {
    key: "maquinaria.prestar",
    module: "maquinaria",
    moduleLabel: "Maquinaria",
    label: "Prestar maquinaria de empresa",
    description: "Permite entregar y devolver maquinaria empresarial a conjuntos.",
  },
  {
  ...
  {
    key: "herramientas.asignar",
    module: "herramientas",
    moduleLabel: "Herramientas",
    label: "Asignar herramientas al cronograma",
    description:
      "Permite asignar y liberar herramientas concretas sobre las necesidades del cronograma.",
  },
  {
    key: "herramientas.crear",
    module: "herramientas",
    moduleLabel: "Herramientas",
    label: "Registrar herramientas",
    description: "Permite registrar unidades físicas de herramientas.",
  },
  {
    key: "herramientas.editar",
    module: "herramientas",
    moduleLabel: "Herramientas",
    label: "Editar herramientas",
    description: "Permite editar herramientas aprobadas y sus datos administrativos.",
  },
  {
    key: "herramientas.aprobar",
    module: "herramientas",
    moduleLabel: "Herramientas",
    label: "Aprobar herramientas",
    description: "Permite aprobar o rechazar altas pendientes de herramientas.",
  },
  {
    key: "herramientas.gestionar_estado",
    module: "herramientas",
    moduleLabel: "Herramientas",
    label: "Gestionar estado de herramientas",
    description: "Permite cambiar el estado físico o retirar herramientas.",
  },
  {
    key: "herramientas.prestar",
    module: "herramientas",
    moduleLabel: "Herramientas",
    label: "Prestar herramientas de empresa",
    description: "Permite entregar y devolver herramientas empresariales a conjuntos.",
  },
  {
