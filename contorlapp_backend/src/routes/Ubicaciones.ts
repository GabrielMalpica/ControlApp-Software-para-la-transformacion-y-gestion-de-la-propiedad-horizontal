...
router.post("/ubicaciones/:ubicacionId/elementos", requirePermission("mapa_areas.gestionar"), requireResourceScope("ubicacion", "ubicacionId"), controller.agregarElemento);
