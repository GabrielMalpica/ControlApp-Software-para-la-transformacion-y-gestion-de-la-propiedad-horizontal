...
conjuntoRouter.put("/conjuntos/:nit/activo", requirePermission("conjuntos.gestionar"), requireConjuntoScope("nit"), c.setActivo);
...
conjuntoRouter.post("/conjuntos/:nit/maquinaria/entregar", requirePermission("maquinaria.asignar"), requireConjuntoScope("nit"), c.entregarMaquinaria);
conjuntoRouter.get("/:nit/maquinaria", requirePermission("maquinaria.ver", "maquinaria.asignar"), requireConjuntoScope("nit"), c.listarMaquinaria);
conjuntoRouter.get(
  "/conjuntos/:nit/mapa",
...
conjuntoRouter.put(
  "/conjuntos/:nit/mapa",
  requirePermission("mapa_areas.gestionar"),
  requireConjuntoScope("nit"),
