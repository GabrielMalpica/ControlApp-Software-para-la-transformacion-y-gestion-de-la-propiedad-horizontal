...
exports.EditarUsuarioDTO = zod_1.z.object({
    ...
    estadoCivil: zod_1.z.nativeEnum(client_1.EstadoCivil).optional(),
    numeroHijos: zod_1.z.number().int().min(0).optional(),
    padresVivos: zod_1.z.boolean().optional(),
    tipoSangre: zod_1.z.nativeEnum(client_1.TipoSangre).optional(),
    eps: zod_1.z.nativeEnum(client_1.EPS).optional(),
    fondoPensiones: zod_1.z.nativeEnum(client_1.FondoPension).optional(),
    tallaCamisa: zod_1.z.nativeEnum(client_1.TallaCamisa).optional(),
    tallaPantalon: zod_1.z.nativeEnum(client_1.TallaPantalon).optional(),
    tallaCalzado: zod_1.z.nativeEnum(client_1.TallaCalzado).optional(),
    tipoContrato: zod_1.z.nativeEnum(client_1.TipoContrato).optional(),
