...
exports.SolicitudInsumoService = void 0;
...
class SolicitudInsumoService {
    ...
    async crear(payload, actorId) {
        ...
        try {
            ...
            console.error("No se pudo notificar creacion de solicitud de insumos:", e);
        }
        return creada;
    }
    async aprobar(id, payload) {
        const dto = SolicitudInsumo_1.AprobarSolicitudInsumoDTO.parse(payload);
    ...
    async listar(payload) {
        const f = SolicitudInsumo_1.FiltroSolicitudInsumoDTO.parse(payload);
...
exports.SolicitudInsumoService = SolicitudInsumoService;
